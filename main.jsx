...
const goats=[
{id:"GOAT-001",name:"Bima",breed:"Etawa",gender:"Male",age:"14 months",weight:58,status:"Active",price:420,image:"https://images.unsplash.com/photo-1524024973431-2ad916746881?auto=format&fit=crop&w=900&q=80",health:"Healthy",camera:"LIVE"},
{id:"GOAT-002",name:"Luna",breed:"Boer",gender:"Female",age:"11 months",weight:51,status:"Active",price:390,image:"https://images.unsplash.com/photo-1566251037378-5e04e3bec343?auto=format&fit=crop&w=900&q=80",health:"Healthy",camera:"LIVE"},
{id:"GOAT-003",name:"Jaya",breed:"Etawa",gender:"Male",age:"16 months",weight:64,status:"Active",price:465,image:"https://images.unsplash.com/photo-1533318087102-b3ad366ed041?auto=format&fit=crop&w=900&q=80",health:"Healthy",camera:"OFFLINE"},
{id:"GOAT-004",name:"Moka",breed:"Boer",gender:"Female",age:"18 months",weight:67,status:"Sold",price:500,image:"https://images.unsplash.com/photo-1551884831-bbf3cdc6469e?auto=format&fit=crop&w=900&q=80",health:"Healthy",camera:"OFFLINE",sale:1000,cost:100,share:90},
{id:"GOAT-005",name:"Raka",breed:"Kacang",gender:"Male",age:"9 months",weight:43,status:"Available",price:315,image:"https://images.unsplash.com/photo-1484557985045-edf25e08da73?auto=format&fit=crop&w=900&q=80",health:"Healthy",camera:"LIVE"}
];
...
function Home({nav}){return <main><section className="hero"><div><div className="pill">● REAL WORLD ASSET • MVP</div><h1>Own a real goat.<br/><em>Track it. Earn from it.</em></h1><p>GoatRWA connects physical goats with digital records, live farm monitoring and transparent sale distributions.</p><div className="actions"><button className="primary" onClick={()=>nav("market")}>Explore Goats <ChevronRight/></button><button className="secondary" onClick={()=>nav("camera")}>Watch Live Camera <Camera/></button></div></div><div className="heroCard"><img src="https://images.unsplash.com/photo-1524024973431-2ad916746881?auto=format&fit=crop&w=1000&q=80"/><div className="live"><span/> LIVE FARM CAMERA</div><div className="overlay"><b>GOAT-001</b><span>Etawa • 58 kg</span></div></div></section><section className="stats">{[["128","Goats tracked"],["96","NFTs issued"],["81","Active goats"],["$24.8K","Sales recorded"]].map(x=><div><strong>{x[0]}</strong><span>{x[1]}</span></div>)}</section><section className="section"><div className="sectionHead"><div><div className="eyebrow">FEATURED ASSETS</div><h2>Meet the goats</h2></div><button className="link" onClick={()=>nav("market")}>View all <ChevronRight/></button></div><div className="grid">{goats.slice(0,3).map(g=><GoatCard key={g.id} g={g} onClick={()=>{nav("goat");}} select={()=>{}} />)}</div></section></main>}
